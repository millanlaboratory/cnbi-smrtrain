...
%         end        
        ...
        if(Csettings{class_idx}.modules.smr.options.classification.gau)
            Name = [SubjectID '_' Modality '_' Date '.smr.original.mat'];
            ...
            NameAnalysis = [SubjectID '_' Modality '_' Date '.original.mat'];
        ...
        if(exist('GauFull', 'var'))
            ...
            settings = GauFull;
            save(Name, 'settings');
            disp(['[eegc3_smr_train] Saved eegc3 CNBI Gaussian classifier/settings trained with all available data ' ...
            Classifiers{i}.modality ': ' Name]);
            ...
            save(NameAnalysis, 'analysis');
            disp(['[eegc3_smr_train] Saved eegc2 classifier CNBI Gaussian classifier/settings trained with all available data ' ...
                Classifiers{i}.modality ': ' NameAnalysis]);
        end      
